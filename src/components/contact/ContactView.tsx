    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-10 animate-in fade-in duration-300">
      ...
      <div className="py-6 border-b border-slate-100 space-y-2">
        ...
        <p className="text-xs sm:text-sm text-slate-600 max-w-2xl leading-relaxed">
          Get in touch with our mechatronics support engineering team,
          institutional lab setup consultants, and sales desk.
        </p>
      </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-white block">
                    Phone Desk (Click-to-Call)
                  </span>
                  <a
                    href={`tel:${COMPANY_INFO.phone}`}
                    className="text-slate-300 hover:text-[#00AEEF]"
                  >
                    {COMPANY_INFO.phone}
                  </a>
                </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 space-y-2 text-xs">
            <h4 className="font-extrabold text-slate-900 flex items-center gap-1.5">
              <Headphones className="w-4 h-4 text-[#00AEEF]" /> Registered
              Customer?
            </h4>
            <p className="text-slate-500">
              Logged-in customers can submit trackable helpdesk support tickets
              directly.
            </p>
            <Link
              href="/account/support"
              className="text-xs font-black text-[#00AEEF] hover:underline block pt-1"
            >
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-2xs space-y-6">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Fill in the contact form below. Our response team typical responds
          ...
          {!submitted ? (
            ...
            <div className="text-center py-10 space-y-4">
              ...
              <p className="text-xs text-slate-600 max-w-xs mx-auto leading-relaxed">
                Our support team has recorded your contact submission for{" "}
                {email}.
              </p>
            </div>
          )}
