        ...
        {stats.map((stat, idx) => (
          <div
            ...
            className={`flex flex-col justify-center p-1 sm:p-0 ${
              idx % 2 === 1 ? 'border-l border-slate-100 pl-2 sm:pl-0 sm:border-l-0' : ''
            } ${
              idx >= 2 ? 'border-t border-slate-100 pt-2 sm:border-t-0 sm:pt-0' : ''
          ...
          >
            <div className="flex items-center gap-1 sm:gap-2 mb-0.5 sm:mb-2">
              <stat.icon className={`w-3.5 h-3.5 sm:w-5 sm:h-5 ${stat.color} shrink-0`} />
