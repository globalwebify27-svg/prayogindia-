        ...
        {priceOpen && (
          <div className="space-y-3 pl-1 pr-1">
            <div className="flex items-center justify-between font-extrabold text-slate-900 text-xs">
              <span className="bg-slate-100 px-2.5 py-1 rounded-md border border-slate-200 font-mono">
                ₹{priceRange[0]}
              </span>
        ...
        {techSpecsOpen && (
          <div className="space-y-4 pl-1">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {["1000 KV", "1400 KV", "2300 KV", "300 RPM", "600 RPM"].map(
                  (rpm) => (
                    <button
                      key={rpm}
                      onClick={() =>
                ...
                {[
                  ...
                  <button
                    ...
                    onClick={() =>
                      onTechSpecChange?.(
                        "compatibility",
                        techSpecs.compatibility === comp ? null : comp,
                      )
                    }
                    className={`px-2.5 py-1 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
                ...
                {[
                  ...
                  <button
                    ...
                    onClick={() =>
                      onTechSpecChange?.(
                        "material",
                        techSpecs.material === mat ? null : mat,
                      )
                    }
                    className={`px-2.5 py-1 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
          ...
          {[4, 4.5, 5].map((rating) => (
            <button
              ...
              onClick={() =>
                onTechSpecChange?.(
                  "minRating",
                  techSpecs.minRating === rating ? null : rating,
                )
              }
              className={`px-2.5 py-1 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
          ...
          {[10, 20, 30, 40, 50].map((pct) => (
            <button
              ...
              onClick={() =>
                onTechSpecChange?.(
                  "minDiscount",
                  techSpecs.minDiscount === pct ? null : pct,
                )
              }
              className={`px-2.5 py-1 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
          ...
          <div className="space-y-2 pl-1">
            ...
            <div className="space-y-1 max-h-40 overflow-y-auto scrollbar-none">
              {filteredBrands.map((b) => (
                <label
                  key={b.id}
                  className="flex items-center gap-2 cursor-pointer py-1 px-1 hover:bg-slate-50 rounded"
                >
                  <input
                    type="checkbox"
