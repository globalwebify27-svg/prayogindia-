    ...
    <div className="space-y-6 max-w-4xl">
      <div className="border-b border-slate-200 pb-4">
        ...
        <p className="text-xs text-slate-500 font-medium">
          Manage {title.toLowerCase()} catalog and database content
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-2xs text-center space-y-3">
        ...
        <p className="text-xs text-slate-500 max-w-md mx-auto">
          All {title.toLowerCase()} changes made through this portal immediately
          update the customer-facing website via the unified PostgreSQL database
          engine.
        </p>
      </div>
    </div>
