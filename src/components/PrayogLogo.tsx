    ...
    <div className={`inline-flex flex-col items-start select-none group cursor-pointer ${className}`}>
      ...
      <div className="flex items-center gap-1 font-black tracking-tight font-sans leading-none">
        ...
        <div className={`relative flex items-center justify-center shrink-0 ${iconSizes[size]}`}>
          <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-[#00AEEF]">
            {/* Left Antenna */}
            ...
            {/* Gear Eye - Left */}
            <g className="animate-spin-slow" style={{ transformOrigin: '22px 30px' }}>
            ...
            {/* Gear Eye - Right */}
            <g className="animate-spin-slow" style={{ transformOrigin: '42px 30px' }}>
