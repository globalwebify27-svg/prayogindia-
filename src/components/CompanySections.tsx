      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            Prayog India is a premier technological enterprise delivering
            certified robotics, microcontrollers, UAV components, and turnkey
            STEM educational laboratories for institutions, researchers, and
            industrial makers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              To empower every academic institution, engineering laboratory, and
              tech innovator across India with authentic, industrial-grade
              hardware tools and hands-on robotics skill ecosystems.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Accelerate national STEM education and hardware R&D by providing
              10,000+ verified components, rapid dispatch logistics, and expert
              technical support for next-generation drone and AI systems.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm space-y-6">
          <h3 className="text-2xl font-extrabold text-slate-900 text-center">
            Why Institutions Choose Prayog India
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="space-y-2 p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs text-slate-500">
                Directly sourced microcontrollers and sensors with full quality
                guarantee.
              </p>
            </div>
            ...
            <div className="space-y-2 p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <h4 className="text-sm font-bold text-slate-900">
                GST Invoice & Institutional Quotes
              </h4>
              <p className="text-xs text-slate-500">
                Custom B2B proforma invoicing with government & university
                compliance.
              </p>
            </div>
            ...
            <div className="space-y-2 p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <p className="text-xs text-slate-500">
                In-house robotics engineers providing schematic and code
                troubleshooting.
              </p>
            </div>
            ...
            <div className="space-y-2 p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <h4 className="text-sm font-bold text-slate-900">
                500+ Labs Established
              </h4>
              <p className="text-xs text-slate-500">
                Turnkey laboratory setups active in premier Indian engineering
                colleges.
              </p>
            </div>
          </div>
...
export const ServicesSection: React.FC<FullSectionsProps> = ({
  onOpenB2BModal,
}) => {
  const servicesList = [
    {
      ...
      description:
        "End-to-end K-12 and university STEM tinkering labs complete with 3D printers, coding kits, and curriculum modules.",
      features: [
        "Curriculum-mapped DIY kits",
        "Safety & workbench layout",
    ...
    },
    {
      ...
      description:
        "Advanced industrial robotics labs featuring 6-axis manipulator arms, AGV mobile platforms, and ROS 2 simulation workstations.",
      features: [
        "Collaborative robot arms",
        "SLAM LiDAR navigation rovers",
        "ROS 2 Workstations",
      ],
      apps: [
    ...
    },
    {
      ...
      description:
        "Comprehensive UAV design & testing labs with flight simulation cages, telemetry stations, and DGCA compliant flight kits.",
      features: [
        "Quadcopter assembly bays",
        "PID tuning & ground station",
        "Safety flight netting",
      ],
      apps: [
    ...
    },
    {
      ...
      description:
        "Custom prototype engineering, embedded system hardware design, and smart factory IoT automation solutions.",
      features: [
    ...
    },
    {
      ...
      description:
        "Expert engineering consulting for hardware component selection, BOM optimization, and academic lab accreditation.",
      features: [
        "BOM cost optimization",
        "Component lifecycle analysis",
        "Grant & lab proposal design",
      ],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Empowering institutions and enterprises with turnkey laboratories,
            technical consulting, and industrial prototype development.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesList.map((srv) => {
            ...
            return (
              <div
                key={srv.id}
                className="bg-slate-50 rounded-3xl border border-slate-200 overflow-hidden flex flex-col justify-between hover:shadow-lg transition-all group"
              >
                <div>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Have a technical query, order question, or institutional
            requirement? Our team responds within 2 hours.
          </p>
        </div>
            ...
            <div className="space-y-4 text-xs">
              <div className="flex items-start gap-4 p-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div>
                  <h4 className="font-bold text-slate-900">
                    Head Office & Lab Facility
                  </h4>
                  <p className="text-slate-500 leading-relaxed">
                    Prayog India Tech Hub, Plot 42, Electronics City Phase 1,
              ...
              <div className="flex items-start gap-4 p-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    support@prayogindia.com | sales@prayogindia.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-3 bg-slate-50 rounded-2xl border border-slate-100">
                ...
                <div>
                  ...
                  <p className="text-slate-500">
                    +91 (080) 4567 8900 / +91 98765 43210
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-3 bg-emerald-50 rounded-2xl border border-emerald-100 text-emerald-900">
                ...
                <div>
                  ...
                  <p className="text-emerald-700">
                    Instant Technical Support: +91 98765 43210
                  </p>
                </div>
              </div>
            </div>
            ...
            {formSubmitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  Thank you for reaching out to Prayog India. Our technical desk
                  will contact you via email/phone shortly.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div className="text-xs">
                  ...
                  <textarea
                    required
                    rows={4}
                    placeholder="Describe your requirement, components needed, or questions..."
                    className="w-full bg-slate-50 p-3 rounded-xl border border-slate-200 focus:outline-none"
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#00AEEF] hover:bg-[#0096D6] text-white py-3.5 rounded-xl text-xs font-extrabold flex items-center justify-center gap-2 shadow-sm transition-colors"
                >
    ...
    <section id="careers" className="py-16 bg-white border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-sm text-slate-600">
            Join our team of hardware engineers, educators, and robotics
            visionaries building India&apos;s leading STEM platform.
          </p>
        </div>
        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {jobs.map((j) => (
            <div
              key={j.id}
              className="bg-slate-50 p-6 rounded-3xl border border-slate-200 flex flex-col sm:flex-row justify-between sm:items-center gap-4 hover:border-[#00AEEF] transition-all"
            >
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="bg-slate-200 text-slate-800 text-[10px] font-bold px-2.5 py-0.5 rounded-md uppercase">
                    {j.dept}
                  </span>
                  <span className="bg-[#E0F7FC] text-[#00AEEF] text-[10px] font-bold px-2.5 py-0.5 rounded-md">
                    {j.type}
                  </span>
                </div>
            ...
            <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-8 z-10 space-y-4">
              ...
              {applicationSuccess ? (
                <div className="text-center py-6 space-y-3">
                  ...
                  <p className="text-xs text-slate-500">
                    Our HR team will review your application for {appliedJob}{" "}
                  ...
                  <button
                    ...
                    className="bg-slate-900 text-white text-xs font-bold px-5 py-2 rounded-full"
                  >
                    Done
                  </button>
                </div>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      value={appliedJob}
                      className="w-full bg-slate-100 p-2.5 rounded-xl font-bold text-slate-800"
                    />
                  </div>
                  <div>
                    <label className="font-bold text-slate-700 block mb-1">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#00AEEF] hover:bg-[#0096D6] text-white py-3 rounded-xl font-bold shadow-sm"
                  >
                    Submit Application
                  </button>
                </form>
