...
const REGISTRATION_BENEFITS = [
  {
    ...
    description: 'Track dispatch, courier AWB numbers & real-time delivery status.',
  },
  {
  ...
  },
  {
    ...
    description: 'Save multiple lab, college, office, and home shipping addresses.',
  },
  {
    icon: <Coins className="w-5 h-5 text-amber-500" />,
    title: 'Reward Points (Prayog Coins)',
    description: 'Earn 100 welcome coins + coins on every order for instant discounts.',
  },
  {
  ...
  },
  {
    ...
    description: 'Pre-filled billing, GSTIN numbers & express delivery options.',
  },
];
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="text-center space-y-1.5 max-w-lg mx-auto">
        ...
        <p className="text-xs text-slate-500">
          Register to access student/maker discounts, track lab shipments, and earn Prayog Coins.
        </p>
      </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-xl space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="space-y-1">
              <label className="font-extrabold text-slate-700 block">Full Name *</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* 2. Mobile Number */}
              <div className="space-y-1">
                <label className="font-extrabold text-slate-700 block">Mobile Number *</label>
                <div className="relative">
                ...
                {phone.length > 0 && !isPhoneValid && (
                  <span className="text-[10px] text-amber-600 font-bold block">Must be 10 digits</span>
                )}
              </div>

              {/* 3. Email */}
              <div className="space-y-1">
                <label className="font-extrabold text-slate-700 block">Email Address *</label>
                <div className="relative">
                ...
                {email.length > 0 && !isEmailValid && (
                  <span className="text-[10px] text-amber-600 font-bold block">Valid email required</span>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="space-y-1">
                ...
                {password.length > 0 && !isPasswordLengthValid && (
                  <span className="text-[10px] text-amber-600 font-bold block">Min. 6 characters</span>
                )}
              </div>
              ...
              <div className="space-y-1">
                ...
                {confirmPassword.length > 0 && !isPasswordMatch && (
                  <span className="text-[10px] text-red-500 font-bold block">Passwords do not match</span>
                )}
              </div>
            </div>
            ...
            <div className="pt-2">
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-[11px] text-slate-600 font-medium leading-relaxed">
                  ...
                  <Link href="/about" className="text-[#00AEEF] font-bold hover:underline">Terms of Service</Link>{' '}
                  &amp;{' '}
                  <Link href="/about" className="text-[#00AEEF] font-bold hover:underline">Privacy Policy</Link>.
                </span>
              </label>
            </div>
            ...
            >
              <span>{loading ? 'Creating Account & Securing Password...' : 'Create Free Account'}</span>
        ...
        <div className="lg:col-span-5 bg-[#0F172A] text-white rounded-3xl p-6 sm:p-7 border border-slate-800 shadow-2xl space-y-6">
          <div className="border-b border-slate-800 pb-3">
            ...
            <p className="text-xs text-slate-400">
              Why 50,000+ makers, engineers &amp; institutions trust Prayog India.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#00AEEF]/20 to-[#FFC20E]/10 border border-[#00AEEF]/30 p-4 rounded-2xl flex items-center gap-3">
            ...
            <div className="text-[11px] text-slate-300 font-medium leading-tight">
              100% Genuine Certified Hardware &amp; Instant GST Invoices for Colleges &amp; Businesses.
            </div>
          </div>
        </div>
