...
const FEATURES: FeatureCard[] = [
  {
    ...
    description: 'Directly sourced components from official microchip manufacturers with full GST invoice compliance.'
  },
  {
    id: '2',
    icon: <Truck className="w-6 h-6 text-[#00AEEF]" />,
    title: 'Fast Dispatch Across India',
    description: 'Express courier shipping with real-time tracking for schools, colleges, and DIY makers.'
  },
  {
    id: '3',
    icon: <Headphones className="w-6 h-6 text-[#FFC20E]" />,
    title: 'Dedicated Technical Support',
    description: 'In-house robotics engineers available to solve pinout queries, driver issues, and code troubleshooting.'
  },
  {
    id: '4',
    icon: <GraduationCap className="w-6 h-6 text-[#00AEEF]" />,
    title: 'STEM & Institutional Experts',
    description: 'Over 500+ school and university STEM labs designed and commissioned across India.'
  },
  {
    id: '5',
    icon: <Lock className="w-6 h-6 text-[#FFC20E]" />,
    title: 'Secure Shopping Guarantee',
    description: '256-bit encrypted checkout with UPI, Net Banking, Credit Cards, and GST Purchase orders.'
  },
  {
    id: '6',
    icon: <Users className="w-6 h-6 text-[#00AEEF]" />,
    title: 'Vibrant Learning Community',
    description: 'Free access to build tutorials, open-source code repositories, and flight tuning workshops.'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-500">
            India’s trusted ecosystem for authentic robotics hardware, institutional lab setups & technical support.
          </p>
        </div>
