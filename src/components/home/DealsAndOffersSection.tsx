    ...
    <section className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <span>View All Deals</span> <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-gradient-to-br from-[#0A1128] via-[#0F172A] to-[#1E56A0] text-white rounded-3xl p-6 sm:p-8 relative overflow-hidden border border-[#D4AF37]/30 shadow-xl flex flex-col justify-between min-h-[300px]">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 z-10">
              ...
              <div className="flex items-center gap-1.5 text-xs font-bold bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/15">
                ...
                <span className="bg-[#FFC20E] text-slate-950 font-mono font-black px-1.5 py-0.5 rounded text-[11px]">14h</span>
                <span>:</span>
                <span className="bg-[#FFC20E] text-slate-950 font-mono font-black px-1.5 py-0.5 rounded text-[11px]">32m</span>
                <span>:</span>
                <span className="bg-[#FFC20E] text-slate-950 font-mono font-black px-1.5 py-0.5 rounded text-[11px]">45s</span>
              </div>
            </div>
            ...
            <div className="space-y-3 z-10 my-4">
              ...
              <p className="text-slate-200 text-xs sm:text-sm max-w-lg leading-relaxed">
                Get up to ₹2,500 Instant Discount on bulk robotics lab kits, Raspberry Pi 5 bundles & Pixhawk flight controllers.
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 z-10">
              ...
              <div className="text-xs text-slate-300">
                Use Coupon Code: <code className="bg-slate-950 text-[#FFC20E] font-mono font-black px-2 py-1 rounded border border-[#FFC20E]/40">PRAYOG10</code>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6 flex flex-col justify-between">
            ...
            >
              ...
              <h4 className="text-base font-extrabold text-slate-900">Flat 10% Off For New Makers</h4>
              <p className="text-xs text-slate-500">Sign up and get instant discount on your first order of microcontrollers.</p>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-base font-extrabold text-slate-900">Free Express Shipping on Orders &gt; ₹999</h4>
              <p className="text-xs text-slate-600">Guaranteed 100% genuine components with GST compliance.</p>
            </motion.div>
