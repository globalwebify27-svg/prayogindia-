...
export const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    name: "STEM Lab Setup",
    shortDescription:
      "Turnkey K-12 STEM & Tinkering laboratory setup with curriculums, microcontrollers, sensor kits, and trainer certification.",
    image:
      "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80",
    bannerImage:
      "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1200&q=80",
    description:
      "Prayog India provides end-to-end turnkey STEM (Science, Technology, Engineering, & Mathematics) Innovation Lab setups for schools and educational institutions. We equip institutions with modular workbenches, microchip kits, 3D printers, and structured hands-on curriculums.",
    features: [
  ...
  },
  {
    ...
    shortDescription:
      "Advanced mechatronics, mobile robotics, ROS integration, and industrial manipulator arm lab installations.",
    image:
      "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80",
    bannerImage:
      "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=1200&q=80",
    description:
      "Complete Robotics & Mechatronics research lab design for polytechnics and universities. Outfitted with ROS-compatible mobile platforms, 6-DOF robotic arms, LiDAR navigation modules, and real-time motor control benches.",
    features: [
  ...
  },
  {
    ...
    shortDescription:
      "UAV assembly, flight controller tuning, telemetry calibration, and pilot simulation training facilities.",
    image:
      "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?auto=format&fit=crop&w=800&q=80",
    bannerImage:
      "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?auto=format&fit=crop&w=1200&q=80",
    description:
      "Institutional Drone Technology & Unmanned Aerial Vehicle (UAV) lab infrastructure. Includes Pixhawk 6C testing rigs, ESC calibration stations, RF spectrum analyzers, and indoor safety mesh flight nets.",
    features: [
  ...
  },
  {
    ...
    shortDescription:
      "Custom embedded systems development, IoT telemetry, industrial automation, and hardware prototyping.",
    image:
      "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=800&q=80",
    bannerImage:
      "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=1200&q=80",
    description:
      "Prayog India executes specialized industrial hardware engineering projects for manufacturing units, defense startups, and IoT enterprises. From custom PCB layout to firmware deployment.",
    features: [
  ...
  },
  {
    ...
    name: "Consultancy",
    shortDescription:
      "Technical advisorship for curriculum design, procurement planning, lab accreditation, and research grants.",
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80",
    bannerImage:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80",
    description:
      "Expert technical consultancy services for academic leadership, government departments, and corporate CSR wings seeking to establish state-of-the-art technology initiatives.",
    features: [
