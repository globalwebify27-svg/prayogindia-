...
export const INITIAL_STORES: PhysicalStoreBranch[] = [
  {
    ...
    authorizedDevices: [
      ...
      {
        id: "dev-rnc-kiosk-01",
        deviceName: "Ranchi Tablet (Store Shopping Device #1)",
        deviceModel: "Samsung Galaxy Tab S9 FE (Kiosk Stand)",
        token: "PRG_KIOSK_AUTH_RNC_TAB01",
        assignedStaff: "Ranchi Store Kiosk Desk",
        status: "Active / Paired",
        lastActiveAt: "Just now",
      },
      {
  ...
  },
  {
    ...
    authorizedDevices: [
      ...
      {
        id: "dev-pat-kiosk-01",
        deviceName: "Patna Tablet (Store Shopping Device #1)",
        deviceModel: "Lenovo Tab P12 (Kiosk Stand)",
        token: "PRG_KIOSK_AUTH_PAT_TAB01",
        assignedStaff: "Patna Store Kiosk Desk",
        status: "Active / Paired",
        lastActiveAt: "Just now",
      },
    ],
  },
  {
    ...
    authorizedDevices: [
      ...
      {
        id: "dev-del-kiosk-01",
        deviceName: "Delhi Tablet (Store Shopping Device #1)",
        deviceModel: "iPad Air 5th Gen (Kiosk Stand)",
        token: "PRG_KIOSK_AUTH_DEL_TAB01",
        assignedStaff: "Delhi Store Kiosk Desk",
        status: "Active / Paired",
        lastActiveAt: "Just now",
      },
    ],
  },
  {
    ...
    status: "Operational",
    totalStockUnits: 650,
    monthlyWalkInRevenue: 320000,
    authorizedDevices: [
      {
        id: "dev-bom-kiosk-01",
        deviceName: "Mumbai Tablet (Store Shopping Device #1)",
        deviceModel: "Samsung Galaxy Tab S9 (Kiosk Stand)",
        token: "PRG_KIOSK_AUTH_BOM_TAB01",
        assignedStaff: "Mumbai Store Kiosk Desk",
        status: "Active / Paired",
        lastActiveAt: "Just now",
      },
    ],
