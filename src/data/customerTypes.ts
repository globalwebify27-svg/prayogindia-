...
export type CustomerTypeCode =
  "B2C" | "B2B" | "WALK_IN" | "REGISTERED" | "GUEST";
...
export interface CustomerTypeRule {
  ...
  reports: {
    segmentName: string;
    channelAttribution:
      "ONLINE" | "INSTITUTIONAL" | "STORE_POS" | "OMNICHANNEL";
    trackLTV: boolean;
    description: string;
  };
...
export const CUSTOMER_TYPE_RULES: Record<CustomerTypeCode, CustomerTypeRule> = {
  B2C: {
    ...
    description:
      "Standard retail consumer purchasing through website or mobile app for hobby or personal tinkering.",
    pricing: {
      ruleName: "Standard Retail Price",
      discountPercent: 0,
      description:
        "Standard catalog price and publicly listed manufacturer discounts.",
    },
    promotions: {
    ...
    invoice: {
      ...
      description:
        "Standard consumer retail invoice with CGST/SGST/IGST tax breakup.",
    },
    reports: {
      ...
      trackLTV: true,
      description:
        "Tracks retail cart conversion, average basket size, and organic repurchase rate.",
    },
    rewards: {
      ...
      description:
        "Earns 1 Prayog Coin per ₹100 spent on qualifying hardware kits.",
    },
  },
  ...
  B2B: {
    ...
    description:
      "Corporate, university, school, or research lab account with official GSTIN and bulk institutional purchase terms.",
    pricing: {
      ...
      description:
        "15% institutional procurement discount with Input Tax Credit (ITC) eligibility.",
    },
    promotions: {
      eligibleCoupons: [
        "B2BINSTITUTE",
      ...
      description:
        "Eligible for institutional volume coupons and custom purchase-order agreements.",
    },
    invoice: {
      ...
      includesLoyaltyLedger: false,
      description:
        "Official GST Tax Invoice containing Buyer GSTIN, Company Name, Place of Supply, and HSN/SAC codes.",
    },
    reports: {
      ...
      trackLTV: true,
      description:
        "Institutional volume pipeline, quotation conversion rate, and credit term compliance.",
    },
    rewards: {
  ...
  WALK_IN: {
    ...
    description:
      "In-store physical customer checked out at Ranchi/Patna/Delhi experience center POS.",
    pricing: {
      ruleName: "In-Store POS Special Pricing",
      discountPercent: 5, // 5% in-store instant promotional discount
      description:
        "In-store special pricing, cash round-off benefits, and local walk-in deals.",
    },
    promotions: {
      ...
      allowWholesalePromos: false,
      description:
        "Eligible for physical store scratch vouchers and point-of-sale promo codes.",
    },
    invoice: {
      ...
      includesLoyaltyLedger: false,
      description:
        "Point-of-sale thermal or digital slip with Store ID, Device Token, and Cash/UPI/Card split.",
    },
    reports: {
      ...
      trackLTV: false,
      description:
        "In-store daily cash register ledger, device authorization logs, and local walk-in footfall.",
    },
    rewards: {
      coinsPerHundredRs: 1,
      allowCoinRedemption: true,
      ...
      description:
        "Instant WhatsApp receipt cashback tokens and physical stamp card verification.",
    },
  },
  ...
  REGISTERED: {
    ...
    description:
      "Verified account holder with saved shipping addresses, order history, and Prayog Coin wallet.",
    pricing: {
      ruleName: "Member Loyalty Pricing",
      discountPercent: 5, // 5% member loyalty discount
      description:
        "Exclusive 5% registered member discount plus dynamic Prayog Coin redemption.",
    },
    promotions: {
      eligibleCoupons: [
        "WELCOME10",
      ...
      allowWholesalePromos: false,
      description:
        "Full access to public promotions plus member-only VIP coupon codes.",
    },
    invoice: {
      ...
      description:
        "Comprehensive tax invoice featuring Loyalty Points Earned, Redeemed, and Closing Coin Balance.",
    },
    reports: {
      ...
      trackLTV: true,
      description:
        "Customer lifetime value, repeat retention rate, and loyalty point velocity.",
    },
    rewards: {
      coinsPerHundredRs: 2,
      allowCoinRedemption: true,
      ...
      description:
        "2 Prayog Coins per ₹100 spent, priority express dispatch, and lab workshop tickets.",
    },
  },
  ...
  GUEST: {
    ...
    description:
      "Express non-registered buyer with one-click checkout and automatic account provisioning.",
    pricing: {
    ...
    promotions: {
      ...
      allowWholesalePromos: false,
      description:
        "Eligible for first-purchase welcome coupon upon email verification.",
    },
    invoice: {
      ...
      includesLoyaltyLedger: false,
      description:
        "Express guest receipt including a secure one-click link to claim and activate account.",
    },
    reports: {
      ...
      trackLTV: false,
      description:
        "Guest cart abandonment rate and guest-to-registered account conversion funnel.",
    },
    rewards: {
      coinsPerHundredRs: 1,
      ...
      description:
        "Reward points earned during checkout are held in escrow and credited upon password setup.",
    },
  },
};
...
export function getCustomerTypeCode(type: string): CustomerTypeCode {
  ...
  if (normalized.includes("B2B") || normalized.includes("INSTITUTIONAL"))
    return "B2B";
  if (
    ...
    return "WALK_IN";
  if (normalized.includes("REGISTERED") || normalized.includes("MEMBER"))
    return "REGISTERED";
...
export function calculateCustomerPrice(
  ...
  const code =
    typeof customerType === "string" && customerType in CUSTOMER_TYPE_RULES
...
export function isCouponEligibleForCustomer(
  ...
  if (rule.promotions.eligibleCoupons.includes(upperCoupon)) {
    return {
      ...
      discountPercent: upperCoupon.includes("20")
        ? 20
        : upperCoupon.includes("50")
          ? 50
          : 10,
    };
  }
  ...
  for (const [otherCode, otherRule] of Object.entries(CUSTOMER_TYPE_RULES)) {
    if (
      otherCode !== code &&
      otherRule.promotions.eligibleCoupons.includes(upperCoupon)
    ) {
      return {
        eligible: false,
...
export function calculateEarnedRewards(
  ...
  const coinsEarned = Math.floor(
    (orderTotal / 100) * rule.rewards.coinsPerHundredRs,
  );
