...
export const COMPANY_INFO: CompanyInfo = {
  name: 'Prayog India',
  tagline: 'Leading Mechatronics, STEM & Robotics Technology Ecosystem in India',
  description: 'Prayog India is a premier mechatronics, STEM innovation, and robotics technology ecosystem provider based in Bengaluru, India. We empower educational institutions, universities, and industrial R&D teams with high-precision microcontrollers, drone flight hardware, sensor arrays, and turnkey lab setups.',
  mission: 'To democratize experiential mechatronics and STEM education across India by manufacturing and delivering authentic, high-reliability electronic hardware components and turnkey laboratory setups.',
  vision: 'To build India’s largest indigenous hardware engineering ecosystem for robotics, autonomous drones, and Industry 4.0 automation.',
...
export const JOB_OPENINGS: JobOpening[] = [
  {
    ...
    shortDescription: 'Lead turnkey STEM & Robotics laboratory hardware installations across universities and engineering institutions.',
    responsibilities: [
  ...
  },
  {
    ...
    shortDescription: 'Develop real-time C/C++ firmware and bootloaders for custom IoT sensors and UAV telemetry modules.',
    responsibilities: [
