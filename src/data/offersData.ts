...
export const OFFERS_DATA: OfferItem[] = [
  {
    ...
    shortDescription:
      "Get 25% catalogue discount on complete Arduino UNO R3, flight controllers, and ultrasonic sensor bundles.",
    image:
  ...
  },
  {
    ...
    shortDescription:
      "Flat ₹500 instant checkout voucher on engineering college lab setup & multi-pack developer kits.",
    image:
  ...
  },
  {
    ...
    shortDescription:
      "Special pricing launch for Pixhawk flight controllers, 4-in-1 ESCs, and carbon fiber propeller sets.",
    image:
