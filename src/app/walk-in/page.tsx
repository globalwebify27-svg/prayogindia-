    ...
    <div className="min-h-screen bg-[#0F172A] flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 sm:px-10 py-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-black text-sm tracking-wide">PRAYOG INDIA</div>
            <div className="text-[#00AEEF] text-[10px] font-bold uppercase tracking-widest">In-Store Shopping</div>
          </div>
        </div>
        <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 px-3 py-1.5 rounded-full">
          ...
          <span className="text-emerald-400 text-[10px] font-bold uppercase tracking-wider">3 Stores Live</span>
        </div>
      </div>
      ...
      <div className="text-center pt-12 pb-8 px-6">
        <div className="inline-flex items-center gap-2 bg-[#00AEEF]/10 border border-[#00AEEF]/30 px-4 py-1.5 rounded-full mb-5">
          ...
          <span className="text-[#00AEEF] text-xs font-bold uppercase tracking-widest">Walk-in Store Kiosk</span>
        </div>
        ...
        <p className="text-slate-400 text-sm sm:text-base max-w-md mx-auto font-medium">
          Select your store below to browse products, add to cart, and place your order — our staff will assist you at the counter.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className={`h-28 bg-gradient-to-br ${gradient} flex items-center justify-center relative overflow-hidden`}>
                <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle at 30% 50%, white 0%, transparent 70%)' }} />
                ...
                <div className="absolute top-3 right-3 bg-white/20 border border-white/30 px-2 py-0.5 rounded-full">
                  <span className="text-[10px] font-black text-white uppercase">Open</span>
                </div>
              </div>
              ...
              <div className="p-5 flex flex-col gap-3 flex-1">
                <div>
                  <div className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-0.5">{store.city}</div>
                ...
                <div className="flex flex-wrap gap-1.5 pt-1">
                  {['Browse Products', 'Add to Cart', 'Pay Here'].map((f) => (
                    <span key={f} className="bg-slate-700/80 text-slate-300 text-[10px] font-bold px-2.5 py-1 rounded-full">
                      {f}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-auto pt-3">
                  <div className={`w-full bg-gradient-to-r ${gradient} text-white py-3 px-4 rounded-2xl font-extrabold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg group-hover:scale-[1.02] transition-transform`}>
      ...
      <div className="border-t border-slate-800 py-4 px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-slate-500 text-xs">
          ...
          <span>Secure in-store shopping terminal — Authorized Prayog India Retail System</span>
        </div>
        <div className="flex items-center gap-2 text-slate-500 text-xs">
          <Wifi className="w-3.5 h-3.5 text-emerald-500" />
          <span className="text-emerald-500 font-bold">Connected to Store Network</span>
        </div>
      </div>
