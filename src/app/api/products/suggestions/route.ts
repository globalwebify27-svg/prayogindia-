    ...
    try {
      ...
      return NextResponse.json({
        ...
        data: suggestions.map(s => ({
          ...
          price: s.price,
          mrp: s.mrp,
          image: s.images[0]?.imageUrl || 'https://images.unsplash.com/photo-1553406830-ef2513450d76?auto=format&fit=crop&w=600&q=80',
        })),
      });
    } catch (error) {
      console.warn('Database query failed for search suggestions, falling back to mock dataset', error);
    }
  }
