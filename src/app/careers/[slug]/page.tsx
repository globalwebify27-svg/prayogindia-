...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = job ? `${job.title} | Prayog India Careers` : 'Job Opening | Prayog India';
  const description = job ? job.shortDescription : 'Engineering career opening at Prayog India.';
