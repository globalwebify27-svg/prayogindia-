...
const BRANDS_LIST: BrandInfo[] = [
  {
    ...
    description: 'Official open-source electronics platform based on easy-to-use hardware and software.',
  ...
  },
  {
    ...
    description: 'High-performance single-board computers for education, IoT, and embedded AI development.',
  ...
  },
  {
    ...
    description: 'Leading edge AI platforms including Jetson Orin Nano for computer vision and robotics.',
    badge: 'Authorized Partner',
    productCount: 3,
  },
  {
    ...
    description: 'World-renowned Wi-Fi and Bluetooth wireless microcontrollers (ESP32, ESP32-S3, ESP8266).',
    badge: 'Authorized Partner',
    productCount: 7,
  },
  {
    ...
    description: 'Industry-standard STM32 32-bit ARM Cortex microcontrollers and Nucleo prototyping boards.',
    badge: 'Authorized Partner',
    productCount: 5,
  },
  {
    ...
    description: 'Mission-critical drone autopilots, Pixhawk 6C flight controllers, and precision GNSS receivers.',
    badge: 'Authorized Partner',
    productCount: 6,
  },
  {
    ...
    description: 'Proprietary Indian-engineered mechatronics platforms, ATL Innovation Mega Kits, and SLAM rovers.',
  ...
  },
  {
    ...
    description: 'High-power F405 flight controller stacks, 55A ESCs, and low-latency micro FPV cameras.',
    badge: 'Authorized Partner',
    productCount: 4,
  },
];
      ...
      <div className="bg-[#0F172A] text-white p-6 sm:p-10 rounded-3xl border border-slate-800 shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400 font-bold">100% Genuine Certified Hardware</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-white">
            Official Hardware Brand Partners
          </h1>
          <p className="text-xs sm:text-sm text-slate-300 max-w-2xl font-medium">
            Explore world-class robotics, microcontroller, and autonomous drone brands with official warranty, GST tax invoicing, and pan-India technical support.
          </p>
        </div>

        <div className="flex items-center gap-2 bg-slate-800/80 p-3 rounded-2xl border border-slate-700 text-xs">
          <ShieldCheck className="w-5 h-5 text-emerald-400 shrink-0" />
          <span className="text-slate-300 font-semibold">100% OEM Authenticity Guarantee</span>
        </div>
      </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-slate-400">{brand.country}</span>
              </div>
