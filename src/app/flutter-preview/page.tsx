...
export default function FlutterPreviewPage() {
  ...
  const [cart, setCart] = useState<CartItem[]>([
    {
      ...
      description: 'Official ATmega328P Rev3 microcontroller board for robotics and STEM prototyping.',
      inStock: true,
      quantity: 1
    },
    {
      ...
      description: 'High performance NodeMCU-32S IoT development module with dual Xtensa LX6 processors.',
      inStock: true,
      quantity: 1
    }
  ]);
  ...
  const categories = [
    { id: 'drones', name: 'Drones', icon: Plane, bg: 'bg-blue-50/70 text-[#005CA9] border-blue-200/70 hover:bg-blue-100/60' },
    { id: 'devboards', name: 'Dev Boards', icon: Cpu, bg: 'bg-blue-50/70 text-[#005CA9] border-blue-200/70 hover:bg-blue-100/60' },
    { id: 'arduino', name: 'Arduino', icon: Bot, bg: 'bg-blue-50/70 text-[#005CA9] border-blue-200/70 hover:bg-blue-100/60' },
    { id: 'sensors', name: 'Sensors', icon: Radio, bg: 'bg-blue-50/70 text-[#005CA9] border-blue-200/70 hover:bg-blue-100/60' },
    { id: 'stem', name: 'Stem', icon: FlaskConical, bg: 'bg-blue-50/70 text-[#005CA9] border-blue-200/70 hover:bg-blue-100/60' },
    { id: 'motors', name: 'Motors', icon: Settings, bg: 'bg-blue-50/70 text-[#005CA9] border-blue-200/70 hover:bg-blue-100/60' },
  ];
  ...
  const allProducts: ProductItem[] = [
    {
      ...
      description: 'Complete hands-on STEM electronics lab kit with Arduino Uno, 45 sensors, LCD, and tutorial guide.',
      features: [
      ...
      documents: [
        { title: 'Arduino Starter Kit Lab Manual (PDF)', type: 'PDF', url: '#' },
        { title: 'Sensors Pinout & Circuit Schematic', type: 'Schematic', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4',
      description: 'Carbon fiber racing frame, 4x 2300KV motors, 30A 4-in-1 ESC and high-speed flight controller.',
      features: [
      ...
      documents: [
        { title: 'FPV Drone Assembly & Betaflight Tuning Guide', type: 'Manual', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      description: '40 TOPS generative AI computing powerhouse for autonomous robots and vision AI pipelines.',
      features: [
      ...
      documents: [
        { title: 'NVIDIA Jetson Orin Nano Hardware Reference (PDF)', type: 'PDF', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      description: '360 degree 12-meter range 2D laser LiDAR scanner sensor for SLAM navigation and mapping robots.',
      features: [
      ...
      documents: [
        { title: 'Slamtec RPLIDAR A1 Protocol & SDK Manual', type: 'PDF', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      description: 'Industry standard ATmega328P 8-bit AVR microcontroller board with removable DIP socket.',
      features: [
      ...
      documents: [
        { title: 'Arduino UNO R3 Official Datasheet (PDF)', type: 'PDF', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      description: 'Quad-core Cortex-A72 processor, dual 4K micro HDMI outputs, Gigabit Ethernet, 8GB LPDDR4 RAM.',
      inStock: true
    },
    {
      id: 'esp-32',
      ...
      discount: '35% OFF',
      image: 'https://images.unsplash.com/photo-1608564697071-ddf911d81370?auto=format&fit=crop&w=400&q=80',
      description: 'Dual-core 240MHz Wi-Fi and Bluetooth MCU with ultra-low power coprocessor and rich GPIO.',
      inStock: true
    },
    {
      id: 'rob-arm',
      ...
      description: 'All-metal robotic arm with 6 digital metal-gear servos, claw gripper, and controller board.',
      inStock: true
    },
    {
      id: 'pix-6c',
      ...
      description: 'Next-gen autopilot flight controller for commercial and experimental drones powered by PX4/Ardupilot.',
      inStock: true
    },
    {
      id: 'bldc-kit',
      ...
      discount: '25% OFF',
      image: 'https://images.unsplash.com/photo-1508614589041-895b88991e3e?auto=format&fit=crop&w=400&q=80',
      description: 'High-thrust 2300KV brushless motor with SimonK 30A speed controller for multirotors and quadcopters.',
      inStock: true
    },
    {
      id: 'ai-cam',
      ...
      description: 'On-device neural network camera sensor for face tracking, color detection, and shape classification.',
      inStock: true
    },
    {
      id: 'stepper-nema',
      ...
      description: 'High torque 1.8 degree bipolar stepper motor with A4988 microstepping driver board for 3D printers and CNCs.',
      features: [
    ...
    },
    {
      ...
      description: '2-3x faster Broadcom BCM2712 quad-core 2.4GHz Arm Cortex-A76 processor with dual 4Kp60 HDMI and PCIe 2.0 interface.',
      features: [
      ...
      documents: [
        { title: 'Raspberry Pi 5 Datasheet & Pinout Diagram', type: 'PDF', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      stockCount: 28,
      image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=600&q=80',
      description: 'Integrated 3-axis angular rate sensor (gyroscope) and 3-axis accelerometer with onboard Digital Motion Processor (DMP).',
      features: [
    ...
    },
    {
      ...
      description: 'Precision non-contact sonar ranging module offering 2cm to 400cm ranging accuracy with 3mm precision.',
      features: [
    ...
    },
    {
      ...
      description: 'Lightweight high-output micro servo motor suitable for robot steering, pan-tilt cameras, and RC aircraft control surfaces.',
      features: [
    ...
    },
    {
      ...
      stockCount: 7,
      image: 'https://images.unsplash.com/photo-1508614589041-895b88991e3e?auto=format&fit=crop&w=600&q=80',
      description: 'Ultra-high discharge 120C LiPo battery pack engineered for high-performance FPV racing quads and heavy-lift UAVs.',
      features: [
    ...
    },
    {
      ...
      description: '10-channel 2.4GHz AFHDS 2A digital proportional radio remote control system with telemetry receiver for drones and RC robots.',
      features: [
      ...
      documents: [
        { title: 'FlySky FS-i6X Manual & Firmware Guide', type: 'PDF', url: '#' }
      ],
      inStock: true
    },
    {
      ...
      description: 'Open-source IoT development platform with built-in Wi-Fi, CP2102 USB-to-UART chip, and full Arduino IDE support.',
      features: [
    ...
    },
    {
      ...
      stockCount: 50,
      image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=600&q=80',
      description: 'High power dual full-bridge driver designed to control 2 DC motors (speed and direction) or 1 bipolar 4-wire stepper motor.',
      features: [
    ...
    },
    {
      ...
      stockCount: 19,
      image: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=600&q=80',
      description: 'Precision combined environmental sensor measuring barometric pressure (altitude calculation), ambient temperature, and humidity.',
      features: [
  ...
  const filteredProducts = allProducts.filter((p) => {
    const matchesCat = activeCategoryFilter === 'all' || p.catId === activeCategoryFilter;
  ...
  const cartTotalMRP = cart.reduce((acc, item) => acc + item.mrp * item.quantity, 0);
      ...
      <div className="w-full max-w-[390px] h-[780px] bg-white rounded-[48px] shadow-[0_25px_70px_rgba(0,0,0,0.6)] overflow-hidden border-[8px] border-slate-800 relative flex flex-col ring-1 ring-white/10">
        ...
        <div className="bg-gradient-to-b from-[#003B73] via-[#005CA9] to-[#0072CE] text-white px-5 pt-3 pb-3.5 shrink-0 shadow-md">
          ...
          <div className="flex items-center justify-between mb-3">
            <div 
              onClick={() => { setActiveBottomNav(0); setActiveCategoryFilter('all'); setSearchQuery(''); }}
              className="flex items-center gap-2 cursor-pointer group"
            >
              <div className="w-8 h-8 rounded-xl bg-white p-1 flex items-center justify-center shadow-md">
                <svg viewBox="0 0 64 64" fill="none" className="w-full h-full text-[#00AEEF]">
                  <line x1="20" y1="14" x2="10" y2="4" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
                  <circle cx="9" cy="3" r="3.5" fill="currentColor"/>
                  <line x1="44" y1="14" x2="54" y2="4" stroke="currentColor" strokeWidth="4" strokeLinecap="round"/>
                  <circle cx="55" cy="3" r="3.5" fill="currentColor"/>
                  <rect x="8" y="14" width="48" height="34" rx="9" fill="currentColor"/>
                  ...
                  <path d="M22 41 Q32 45 42 41" stroke="white" strokeWidth="3" strokeLinecap="round" fill="none"/>
                </svg>
              </div>
              <div>
        ...
        {notificationOpen && (
          <div className="absolute top-[130px] inset-x-4 bg-white rounded-2xl shadow-2xl border border-slate-200 z-50 p-3 animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2 mb-2">
              <span className="text-xs font-black text-slate-900">Notifications (2)</span>
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2 bg-blue-50 rounded-xl">
                <div className="font-bold text-blue-950 text-[11px]">🎉 28% OFF on Arduino Kits</div>
                <div className="text-slate-600 text-[9.5px]">Use code PRAYOG300 on checkout today.</div>
              </div>
              <div className="p-2 bg-emerald-50 rounded-xl">
                <div className="font-bold text-emerald-950 text-[11px]">⚡ 30 Min Kiosk Active</div>
                <div className="text-slate-600 text-[9.5px]">Local pickup ready in Patna & Ranchi hubs.</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar bg-slate-50 flex flex-col">
            ...
            <>
              ...
              <div className="px-4 py-3 bg-white flex justify-between items-center shadow-2xs">
                {categories.map((cat) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-11 h-11 rounded-2xl flex items-center justify-center border shadow-xs transition-all ${isSelected ? 'bg-blue-600 text-white scale-105 border-blue-600 ring-2 ring-blue-400/40' : cat.bg}`}>
                        <IconComp className="w-4.5 h-4.5" />
                      </div>
                      <span className={`text-[9.5px] font-bold ${isSelected ? 'text-blue-600' : 'text-slate-700'}`}>
                        {cat.name}
                      </span>
                    </div>
                  );
              ...
              {activeCategoryFilter !== 'all' && (
                <div className="px-4 py-1.5 bg-blue-50 flex items-center justify-between border-b border-blue-100">
                  <span className="text-[10px] font-bold text-blue-900">
                    Filtered by: <span className="uppercase text-blue-600 font-extrabold">{activeCategoryFilter}</span>
                  </span>
                  <button 
              ...
              {activeCategoryFilter === 'all' && (
                <div className="px-4 mt-2.5">
                  <div className={`rounded-3xl overflow-hidden shadow-lg text-white p-3.5 relative bg-gradient-to-r ${heroBanners[activeBannerIndex].gradient} transition-all duration-500`}>
                    <div className="flex items-center justify-between relative z-10">
                      <div className="max-w-[180px]">
                        ...
                        <button 
                          onClick={() => setActiveCategoryFilter(heroBanners[activeBannerIndex].catTarget)}
                        ...
                        >
                          <span>{heroBanners[activeBannerIndex].buttonText}</span>
                    ...
                    {heroBanners.map((_, idx) => (
                      <button
                        ...
                        className={`h-1.5 rounded-full transition-all ${
                          activeBannerIndex === idx ? 'w-4 bg-blue-600' : 'w-1.5 bg-slate-300'
                        }`}
                      />
                    ))}
                  </div>
                  ...
                  {allProducts.slice(0, 4).map((prod) => (
                    ...
                    >
                      <div className="relative mb-1">
                        ...
                        <button 
                          onClick={(e) => { e.stopPropagation(); toggleWish(prod); }}
                        ...
                        >
                          <Heart className={`w-2.5 h-2.5 ${wishlist[prod.id] ? 'fill-rose-500 text-rose-500' : ''}`} />
                        </button>
                        <div className="w-full h-20 rounded-xl overflow-hidden bg-slate-50 flex items-center justify-center p-1">
                          <img src={prod.image} alt={prod.name} className="w-full h-full object-cover rounded-lg group-hover:scale-105 transition" />
                        </div>
                      </div>

                      <div>
                        <span className="text-[7.5px] font-extrabold text-slate-400 uppercase tracking-wider line-clamp-1">{prod.category}</span>
                        <h4 className="text-[9.5px] font-bold text-slate-900 truncate mt-0.5">{prod.name}</h4>
                        ...
                        <div className="flex items-center justify-between mt-1 pt-1 border-t border-slate-100">
                          <div>
                            <div className="text-[11px] font-black text-blue-600 leading-none">₹{prod.price}</div>
                            <div className="text-[8px] text-slate-400 line-through leading-none mt-0.5">₹{prod.mrp}</div>
                          </div>
                          <button 
                ...
                <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
                  {allProducts.slice(4, 9).map((prod) => (
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-[9.5px] font-bold text-slate-800 truncate">{prod.name}</h4>
                        <div className="flex items-center gap-1 mt-0.5 text-[8px] text-slate-500 font-semibold">
                          <Star className="w-2.5 h-2.5 fill-amber-400 text-amber-400" />
                          <span>{prod.rating}</span>
                          <span className="text-slate-400">({prod.reviews})</span>
                        ...
                        <div className="flex items-center justify-between mt-1 pt-1 border-t border-slate-100">
                          <div className="text-[11px] font-black text-blue-600">₹{prod.price}</div>
                          <button 
                            onClick={(e) => { e.stopPropagation(); addToCart(prod); }}
                            className="w-5 h-5 rounded-md bg-blue-600 text-white flex items-center justify-center shadow-xs hover:bg-blue-700 transition"
                          >
              ...
              <div className="px-4 mt-3.5 mb-4">
                <div className="bg-gradient-to-r from-[#005CA9] via-[#0072CE] to-[#00AEEF] text-white rounded-3xl p-3.5 flex items-center justify-between shadow-md relative overflow-hidden">
                  <div className="max-w-[170px] z-10">
                    <h4 className="text-xs font-black text-white leading-tight">New Arrivals</h4>
                    <p className="text-[9px] text-cyan-100 font-medium mt-0.5 mb-2">Latest Kits & Components</p>
                    <button 
                      onClick={() => setActiveBottomNav(1)}
                ...
                <div className="mt-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[9px] font-bold text-slate-500">Fast Dispatch</span>
                  </div>
          ...
          {activeBottomNav === 1 && (
            <div className="p-4 flex flex-col flex-1">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-black text-slate-900">All Hardware Categories</h3>
                <span className="text-xs text-slate-500 font-semibold">{filteredProducts.length} Products</span>
              </div>
                  ...
                  >
                    <div className="relative mb-2">
                      ...
                      <button 
                        ...
                        className="absolute top-1 right-1 p-1 bg-white/80 backdrop-blur-sm rounded-full shadow-2xs text-slate-400 hover:text-rose-500 z-10"
                      >
                        <Heart className={`w-3 h-3 ${wishlist[prod.id] ? 'fill-rose-500 text-rose-500' : ''}`} />
                      </button>
                    ...
                    <div>
                      <span className="text-[8px] font-extrabold text-slate-400 uppercase tracking-wider">{prod.category}</span>
                      <h4 className="text-[10px] font-bold text-slate-900 line-clamp-1 mt-0.5">{prod.name}</h4>
          ...
          {activeBottomNav === 2 && (
            <div className="p-4 flex flex-col flex-1">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-black text-slate-900">Your Shopping Cart ({cartItemCount})</h3>
                <span className="text-xs text-emerald-600 font-bold">Free Shipping on ₹999+</span>
              </div>
              ...
              {cart.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
                  ...
                  <p className="text-xs text-slate-500 mt-1 max-w-[200px]">Explore our robotics kits and start building!</p>
                  <button 
                ...
                <div className="space-y-2.5 flex-1">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="text-xs font-bold text-slate-900 truncate group-hover:text-blue-600 transition">{item.name}</h4>
                  ...
                  <div className="bg-white rounded-2xl p-3 border border-slate-200/80 shadow-2xs mt-4 space-y-1.5 text-xs">
                    ...
                    <div className="border-t border-slate-100 pt-2 flex justify-between items-center text-sm font-black text-slate-900">
                      ...
                      <span className="text-blue-600 text-base">₹{cartTotal}</span>
                    </div>
                  </div>
          ...
          {activeBottomNav === 3 && (
            <div className="p-4 flex flex-col flex-1">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-black text-slate-900">Your Saved Items ({wishlistedProducts.length})</h3>
              ...
              {wishlistedProducts.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
                  ...
                  <h4 className="text-sm font-bold text-slate-900">No items in wishlist</h4>
                  <p className="text-xs text-slate-500 mt-1 max-w-[200px]">Tap the heart icon on any card to save it here!</p>
                  <button 
                    onClick={() => setActiveBottomNav(0)}
                    className="mt-4 bg-blue-600 text-white text-xs font-bold px-4 py-2 rounded-full shadow-md hover:bg-blue-700"
                  >
            ...
            <div className="p-4 flex flex-col flex-1 text-slate-800">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-3xl p-4 mb-3 shadow-md flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-cyan-100">+91 98765 43210 | om@prayog.in</p>
              ...
              <div className="bg-white rounded-2xl p-2 border border-slate-200/80 shadow-2xs space-y-1 mb-3">
                ...
                <div 
                  onClick={() => triggerToast('Default delivery address: Boring Road Hub, Patna (800001)')} 
                  className="flex items-center justify-between p-2.5 rounded-xl hover:bg-slate-50 cursor-pointer text-xs font-bold text-slate-700"
                >
                  <div className="flex items-center gap-2">
          ...
          <div className="absolute inset-0 bg-white z-50 flex flex-col animate-in slide-in-from-right duration-250">
            ...
            <div className="bg-gradient-to-b from-[#003B73] to-[#005CA9] text-white px-4 pt-3 pb-3 shrink-0 shadow-md flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-center">
                  <span className="text-xs font-black tracking-tight uppercase text-white block">Product Details</span>
                  <span className="text-[8px] text-cyan-200 uppercase tracking-widest">{selectedProduct.category}</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <button 
                  ...
                  >
                    <Heart className={`w-4 h-4 ${wishlist[selectedProduct.id] ? 'fill-rose-400 text-rose-400' : ''}`} />
                  </button>
                  <button 
                    onClick={() => {
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar bg-slate-50 p-4 space-y-4">
              ...
              <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-1.5">
                <h1 className="text-sm font-black text-slate-900 leading-snug">{selectedProduct.name}</h1>
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center gap-1 text-amber-500 font-bold text-xs">
                    <Star className="w-3.5 h-3.5 fill-amber-400" />
                    <span>{selectedProduct.rating}</span>
                    <span className="text-slate-400 font-medium">({selectedProduct.reviews} verified reviews)</span>
                  </div>
              ...
              <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-2.5">
                <div className="flex items-baseline gap-2.5">
                  <span className="text-2xl font-black text-blue-600 leading-none">₹{selectedProduct.price}</span>
                  <span className="text-xs text-slate-400 line-through font-bold">₹{selectedProduct.mrp}</span>
                ...
                <div className="flex items-center justify-between text-[10px] text-slate-500 pt-1.5 border-t border-slate-100">
                  <span className="font-medium">Incl. GST (No Hidden Charges)</span>
                  <span className="font-bold text-slate-800">⚡ Free Pan-India Delivery</span>
                </div>

                {/* Urgency Stock Countdown */}
                <div className="pt-1 space-y-1">
                  <div className="flex justify-between text-[9.5px] font-black text-rose-600">
                    <span>🔥 Please hurry! Only {selectedProduct.stockCount || 4} units left in stock</span>
              ...
              <div className="bg-blue-50/60 p-3 rounded-2xl border border-blue-100 space-y-1">
                <span className="text-[9.5px] font-black text-blue-950 uppercase tracking-wider block">Overview & Summary:</span>
              ...
              {selectedProduct.features && selectedProduct.features.length > 0 && (
                <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-2">
                  <span className="text-[10px] font-black uppercase text-slate-900 tracking-wider block">Key Engineering Highlights:</span>
              ...
              {selectedProduct.specs && (
                <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-2">
                  <span className="text-[10px] font-black uppercase text-slate-900 tracking-wider block">Technical Parameters:</span>
                  <div className="grid grid-cols-2 gap-2">
                    {Object.entries(selectedProduct.specs).map(([k, v]) => (
                      <div key={k} className="bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                        <div className="text-[8.5px] font-bold text-slate-400 uppercase">{k}</div>
                        <div className="text-xs font-black text-slate-900 truncate mt-0.5">{v}</div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {selectedProduct.documents && (
                <div className="bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-2 mb-2">
                  ...
                  {selectedProduct.documents.map((doc, idx) => (
                    <div key={idx} className="flex items-center justify-between text-xs font-bold text-blue-600 bg-blue-50/50 p-2 rounded-xl border border-blue-100">
                      <span className="truncate">{doc.title}</span>
                      <span className="text-[8.5px] bg-blue-600 text-white px-2 py-0.5 rounded-md uppercase font-extrabold">{doc.type}</span>
                    </div>
                  ))}
                </div>
              )}
              ...
              <div className="pt-2 pb-6 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    <Sparkles className="w-3.5 h-3.5 text-blue-600 fill-blue-600" />
                    <span className="text-xs font-black text-slate-900">Similar & Related Hardware</span>
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-2.5 overflow-x-auto no-scrollbar pb-1">
                    {allProducts
                      ...
                      .sort((a, b) => {
                        const aSameCat = a.catId === selectedProduct.catId ? 1 : 0;
                        const bSameCat = b.catId === selectedProduct.catId ? 1 : 0;
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1 mt-0.5 text-[8px] text-slate-500 font-semibold">
                              ...
                              <span className="text-[7.5px] text-slate-400">({relProd.reviews})</span>
                            </div>
                            <div className="flex items-center justify-between mt-1 pt-1 border-t border-slate-100">
                              <div>
                                <div className="text-[11px] font-black text-blue-600 leading-none">₹{relProd.price}</div>
                                <div className="text-[8px] text-slate-400 line-through leading-none mt-0.5">₹{relProd.mrp}</div>
                              </div>
                              <button 
                                onClick={(e) => {
                                  e.stopPropagation();
            ...
            <div className="bg-white/95 backdrop-blur-md border-t border-slate-200/80 px-3.5 py-3 flex items-center gap-2.5 shrink-0 shadow-2xl">
              ...
              >
                <Heart className={`w-4 h-4 ${wishlist[selectedProduct.id] ? 'fill-rose-500' : ''}`} />
              </button>
            ...
            <div className="bg-white rounded-t-[32px] max-h-[85%] flex flex-col overflow-hidden shadow-2xl animate-in slide-in-from-bottom duration-300">
              ...
              <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/70">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-slate-900">Secure Express Checkout</h3>
                    <p className="text-[9.5px] text-slate-500 font-medium">100% Encrypted & GST B2B Ready</p>
                  </div>
                </div>
                <button 
                  onClick={() => {
              ...
              <div className="p-4 overflow-y-auto no-scrollbar space-y-3.5 flex-1">
                {orderSuccess ? (
                  <div className="py-6 flex flex-col items-center text-center space-y-3">
                    ...
                    <div>
                      <h4 className="text-base font-black text-slate-900">Order Confirmed!</h4>
                      <p className="text-xs text-slate-500 mt-0.5">Order ID: <span className="font-mono font-bold text-blue-600">{placedOrderId}</span></p>
                    </div>
                    <div className="bg-emerald-50 text-emerald-800 text-xs p-3 rounded-2xl border border-emerald-200 text-left w-full space-y-1">
                      ...
                      <p className="text-[10px] text-emerald-700">Estimated delivery: Tomorrow by 11:00 AM (Free Express Courier with Live GPS Tracking)</p>
                    </div>
                    <button 
                      onClick={() => {
                        setCheckoutModalOpen(false);
                  ...
                  <>
                    ...
                    <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200 space-y-1">
                      ...
                      <div className="flex items-start gap-2 pt-0.5">
                        ...
                        <div>
                          <div className="text-xs font-bold text-slate-900">Om Kumar • +91 98765 43210</div>
                          <div className="text-[10px] text-slate-500">Plot 42, Boring Road Mechatronics Hub, Patna, Bihar - 800001</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      <span className="text-[10px] font-black uppercase text-slate-500">Items in Order ({cartItemCount})</span>
                      <div className="space-y-1.5 max-h-28 overflow-y-auto pr-1">
                        {cart.map((c) => (
                          <div key={c.id} className="flex justify-between items-center text-xs bg-white p-2 rounded-xl border border-slate-100">
                            <span className="truncate max-w-[180px] font-semibold text-slate-800">{c.name} (x{c.quantity})</span>
                            <span className="font-black text-slate-900">₹{c.price * c.quantity}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      <span className="text-[10px] font-black uppercase text-slate-500">Payment Option</span>
                      <div className="grid grid-cols-3 gap-2">
                        <button 
                          onClick={() => setSelectedPaymentMethod('upi')}
                          className={`p-2.5 rounded-2xl border text-center transition flex flex-col items-center gap-1 cursor-pointer ${
                            selectedPaymentMethod === 'upi' ? 'border-blue-600 bg-blue-50 text-blue-700 font-bold ring-2 ring-blue-400/30' : 'border-slate-200 bg-white text-slate-600'
                          }`}
                        >
                        ...
                        <button 
                          ...
                          className={`p-2.5 rounded-2xl border text-center transition flex flex-col items-center gap-1 cursor-pointer ${
                            selectedPaymentMethod === 'card' ? 'border-blue-600 bg-blue-50 text-blue-700 font-bold ring-2 ring-blue-400/30' : 'border-slate-200 bg-white text-slate-600'
                          }`}
                        >
                          <CreditCard className="w-4 h-4 text-emerald-600" />
                        ...
                        <button 
                          ...
                          className={`p-2.5 rounded-2xl border text-center transition flex flex-col items-center gap-1 cursor-pointer ${
                            selectedPaymentMethod === 'cod' ? 'border-blue-600 bg-blue-50 text-blue-700 font-bold ring-2 ring-blue-400/30' : 'border-slate-200 bg-white text-slate-600'
                          }`}
                        >
                    ...
                    <div className="flex items-center gap-2 bg-blue-50/60 p-2 rounded-xl text-[10px] text-blue-900">
                      ...
                      <span>Official 18% GST Tax Invoice will be generated and emailed automatically.</span>
                    </div>
        ...
        {ordersModalOpen && (
          <div className="absolute inset-0 bg-white z-50 flex flex-col animate-in slide-in-from-right duration-250">
            <div className="bg-gradient-to-b from-[#003B73] to-[#005CA9] text-white px-4 pt-3 pb-3 shrink-0 shadow-md flex items-center justify-between">
              <button onClick={() => setOrdersModalOpen(false)} className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <ArrowLeft className="w-4 h-4 text-white" />
              </button>
              <span className="text-xs font-black uppercase tracking-wider">My Hardware Orders</span>
              <div className="w-8"></div>
            </div>

            <div className="p-4 flex-1 overflow-y-auto no-scrollbar space-y-3 bg-slate-50">
              {userOrders.map((ord) => (
                <div key={ord.id} className="bg-white rounded-2xl p-3.5 border border-slate-200/80 shadow-2xs space-y-2">
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="text-xs font-black text-slate-900">{ord.id}</div>
                      <div className="text-[9.5px] text-slate-400 font-semibold">{ord.date}</div>
                    </div>
                    <span className={`text-[8px] font-black px-2 py-0.5 rounded-full border ${ord.statusColor}`}>
                      {ord.status}
                    </span>
                  </div>
                  ...
                  <div className="border-t border-slate-100 pt-2 flex justify-between items-center text-xs">
                    ...
                    <span className="font-black text-blue-600 text-sm">₹{ord.total}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {gstModalOpen && (
          <div className="absolute inset-0 bg-white z-50 flex flex-col animate-in slide-in-from-right duration-250">
            <div className="bg-gradient-to-b from-[#003B73] to-[#005CA9] text-white px-4 pt-3 pb-3 shrink-0 shadow-md flex items-center justify-between">
              <button onClick={() => setGstModalOpen(false)} className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <ArrowLeft className="w-4 h-4 text-white" />
              </button>
              <span className="text-xs font-black uppercase tracking-wider">GST Tax Invoices</span>
              <div className="w-8"></div>
            </div>
            ...
            <div className="p-4 flex-1 overflow-y-auto no-scrollbar space-y-3 bg-slate-50">
              <div className="bg-blue-50 p-3 rounded-2xl border border-blue-100 text-xs text-blue-950 space-y-1">
                ...
                <p className="text-[10px] text-blue-800">Download official 18% input tax credit tax invoices for institutional and laboratory billing.</p>
              </div>

              {userOrders.map((ord) => (
                <div key={ord.id} className="bg-white rounded-2xl p-3 border border-slate-200 shadow-2xs flex justify-between items-center">
                  <div>
                    <div className="text-xs font-bold text-slate-900">{ord.id} - Tax Invoice</div>
                    <div className="text-[10px] text-slate-400">Amount: ₹{ord.total} (Incl. GST)</div>
                  </div>
                  <button 
                    onClick={() => triggerToast(`Downloading PDF Invoice for ${ord.id}...`)}
        ...
        {supportModalOpen && (
          <div className="absolute inset-0 bg-white z-50 flex flex-col animate-in slide-in-from-right duration-250">
            <div className="bg-gradient-to-b from-[#003B73] to-[#005CA9] text-white px-4 pt-3 pb-3 shrink-0 shadow-md flex items-center justify-between">
              <button onClick={() => setSupportModalOpen(false)} className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                <ArrowLeft className="w-4 h-4 text-white" />
              </button>
              <div className="text-center">
                <span className="text-xs font-black uppercase tracking-wider block">Prayog Lab Support</span>
                <span className="text-[8px] text-emerald-300 font-bold">● Hardware Engineer Online</span>
              </div>
              <div className="w-8"></div>
            </div>
            ...
            <div className="p-4 flex-1 overflow-y-auto no-scrollbar space-y-3 bg-slate-50 text-xs">
              <div className="bg-white p-3 rounded-2xl border border-slate-200/80 shadow-2xs space-y-1">
                <div className="font-bold text-slate-900 text-xs">Robotics & Mechatronics Lab Helpdesk</div>
                <p className="text-[10px] text-slate-600">Need wiring schematics, firmware code, or drone PID tuning help? Ask our engineers!</p>
              </div>

              <div className="bg-blue-600 text-white p-3 rounded-2xl rounded-tr-none shadow-xs ml-8 space-y-1">
                <p className="text-xs">Hello! How can I connect the MPU6050 with Arduino UNO for roll and pitch telemetry?</p>
                <span className="text-[8px] text-cyan-200 block text-right">Today, 2:40 PM</span>
              </div>

              <div className="bg-white text-slate-800 p-3 rounded-2xl rounded-tl-none border border-slate-200 shadow-xs mr-8 space-y-1">
                <p className="text-xs">Connect <strong>VCC to 5V</strong>, <strong>GND to GND</strong>, <strong>SDA to Pin A4</strong>, and <strong>SCL to Pin A5</strong>. Use our official Prayog Arduino Starter Library!</p>
                <span className="text-[8px] text-slate-400 block">Today, 2:41 PM</span>
              </div>
            </div>
            ...
            <div className="p-3 bg-white border-t border-slate-200 flex gap-2 items-center">
              ...
              />
              <button 
                onClick={() => triggerToast('Message sent to Prayog Lab Engineer')}
        ...
        <div className="bg-white border-t border-slate-200/80 px-4 py-2 flex justify-between items-center shadow-lg z-30 shrink-0">
          ...
          {/* Home */}
          <button 
            onClick={() => { setActiveBottomNav(0); setActiveCategoryFilter('all'); }}
            className="flex flex-col items-center gap-0.5 flex-1 cursor-pointer"
          >
            <Home className={`w-4.5 h-4.5 ${activeBottomNav === 0 ? 'text-blue-600' : 'text-slate-500'}`} />
            <span className={`text-[10px] font-black ${activeBottomNav === 0 ? 'text-blue-600' : 'text-slate-500'}`}>
              Home
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center gap-0.5 flex-1 cursor-pointer"
          >
            <Grid className={`w-4.5 h-4.5 ${activeBottomNav === 1 ? 'text-blue-600' : 'text-slate-500'}`} />
            <span className={`text-[10px] font-bold ${activeBottomNav === 1 ? 'text-blue-600' : 'text-slate-500'}`}>
              Categories
            </span>
          </button>
          ...
          >
            <div className="relative">
              <ShoppingCart className={`w-4.5 h-4.5 ${activeBottomNav === 2 ? 'text-blue-600' : 'text-slate-500'}`} />
              {cartItemCount > 0 && (
            ...
            <span className={`text-[10px] font-bold ${activeBottomNav === 2 ? 'text-blue-600' : 'text-slate-500'}`}>
              Cart
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center gap-0.5 flex-1 cursor-pointer"
          >
            <Heart className={`w-4.5 h-4.5 ${activeBottomNav === 3 ? 'text-blue-600' : 'text-slate-500'}`} />
            <span className={`text-[10px] font-bold ${activeBottomNav === 3 ? 'text-blue-600' : 'text-slate-500'}`}>
              Wishlist
            </span>
          </button>
          ...
          <button 
            ...
            className="flex flex-col items-center gap-0.5 flex-1 cursor-pointer"
          >
            <User className={`w-4.5 h-4.5 ${activeBottomNav === 4 ? 'text-blue-600' : 'text-slate-500'}`} />
            <span className={`text-[10px] font-bold ${activeBottomNav === 4 ? 'text-blue-600' : 'text-slate-500'}`}>
              Account
            </span>
          </button>
