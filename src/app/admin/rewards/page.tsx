...
export default function AdminRewardsPage() {
  ...
  const [adjustType, setAdjustType] = useState<
    "Earned" | "Admin Adjustment" | "Expired"
  >("Admin Adjustment");
  ...
  const handleCreateAdjustment = (e: React.FormEvent) => {
    ...
    const newEntry: PointsLedgerEntry = {
      ...
      notes:
        adjustNotes.trim() ||
        "Manual adjustment by authorized Store Administrator.",
    };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Configure earning multipliers, checkout redemption caps, validity
            expiry rules, and issue manual customer point adjustments.
          </p>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-black text-slate-900 uppercase tracking-wider flex items-center gap-1.5">
            <Coins className="w-4 h-4 text-[#00AEEF]" /> Customer-Type
            Redemption &amp; Earning Rules
          </h2>
              ...
              <div className="space-y-2 text-xs text-slate-600">
                <div className="flex justify-between">
                  ...
                  <span className="font-black text-slate-900">
                    {rule.pointsPer100Spent} Coin / ₹100 spent
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400 font-bold">
                  ...
                  <span className="font-black text-emerald-600">
                    1 Coin = ₹{rule.redemptionRateRupees}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400 font-bold">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-2xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Real-time audit log of customer earnings, checkout redemptions,
