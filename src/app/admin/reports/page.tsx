...
export type ReportType =
  "SALES" | "INVENTORY" | "CATEGORY" | "STORE" | "FINANCIAL";
...
export default function AdminReportsPage() {
  ...
  const categoryReports = [
    {
      category: "Drone Technology & UAV Kits",
      revenue: 280000,
      qtySold: 42,
      orders: 38,
      aov: 7368,
    ...
    {
      category: "Robotics Kits & STEM Lab Sets",
      revenue: 125000,
      qtySold: 65,
      orders: 45,
      aov: 2777,
    ...
    {
      category: "Arduino, ESP32 & IoT Microcontrollers",
      revenue: 95000,
      qtySold: 140,
      orders: 82,
      aov: 1158,
    ...
    {
      category: "Sensors, Modules & LiDAR",
      revenue: 48000,
      qtySold: 88,
      orders: 56,
      aov: 857,
  ...
  const storeReports = [
    {
      store: "Ranchi Main Branch (Central Hub)",
      onlineSales: 412000,
      posSales: 215000,
      totalRev: 627000,
      orders: 198,
    ...
    {
      store: "Patna Robotics & STEM Branch",
      onlineSales: 0,
      posSales: 165000,
      totalRev: 165000,
      orders: 58,
    ...
    {
      store: "Delhi NCR Innovation Center",
      onlineSales: 0,
      posSales: 248000,
      totalRev: 248000,
      orders: 74,
  ...
  const inventoryReports = [
    ...
    {
      sku: "PRG-BAT-4S52",
      name: "4S 14.8V 5200mAh LiPo Battery Pack",
      totalStock: 12,
      ranchiStock: 8,
      patnaStock: 2,
      delhiStock: 2,
  ...
  const handleExport = (format: "PDF" | "EXCEL" | "CSV") => {
    alert(
      `Generating & exporting ${activeReportType} Report in ${format} format...`,
    );
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Generate and export granular sales, category performance, store-wise
            breakdown, inventory valuation, and financial reports in PDF, CSV,
            and Excel.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Analyze strongest business segments, unit sales, average order
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Compare online orders vs physical store walk-in sales across
                branches.
              </p>
            </div>
            <span className="text-sm font-black text-emerald-600">
              Total Billed: ₹10,40,000
            </span>
          </div>
              ...
              <tbody className="divide-y divide-slate-100 font-medium">
                {storeReports.map((st, i) => (
                  ...
                  >
                    ...
                    <td className="py-3.5 text-right font-mono text-slate-700">
                      ₹{st.onlineSales.toLocaleString()}
                    </td>
                    <td className="py-3.5 text-right font-mono text-slate-700">
                      ₹{st.posSales.toLocaleString()}
                    </td>
                    <td className="py-3.5 text-right font-black text-slate-900 text-sm">
                      ₹{st.totalRev.toLocaleString()}
                    </td>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Real-time inventory levels across Ranchi Hub, Patna, and Delhi
                stores with asset valuation.
              </p>
            </div>
            <span className="text-sm font-black text-[#00AEEF]">
              Stock Value: ₹5,87,200
            </span>
          </div>
              ...
              <tbody className="divide-y divide-slate-100 font-medium">
                {inventoryReports.map((inv, i) => (
                  ...
                  >
                    ...
                    <td className="py-3.5 text-center font-bold text-blue-800">
                      {inv.ranchiStock}
                    </td>
                    <td className="py-3.5 text-center font-bold text-slate-700">
                      {inv.patnaStock}
